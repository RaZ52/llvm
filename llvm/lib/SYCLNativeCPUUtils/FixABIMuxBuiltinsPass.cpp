//===-- FixABIMuxBuiltinsPass.cpp - Convert to Mux Builtins ---===//
//
...
PreservedAnalyses FixABIMuxBuiltinsPass::run(
    Module &M, ModuleAnalysisManager &AM) {
  bool Changed = false;

  auto functionNeedsFixing = [&M](Function &F, bool &Vi2DoubleUpdate) {
